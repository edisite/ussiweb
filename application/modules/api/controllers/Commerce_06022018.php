...
//                $this->biaya_adm_agen     = $val_postpaid->price_selling  ? $val_postpaid->price_selling : 0;
        ...
        if(strtolower($topup_respon_code) != '00'){
            if($topup_respon_code == '04'){
                ...
                $data = array('status' => FALSE,'error_code' => '603','message' => 'plnid tidak terdaftar','data' => $this->res_result);       
...
//            'NO_REKENING'       =>$in_rkning, 
    ...
    function _Check_prm_topup($var = '',$errorcode = '',$trace_id = '',$field = '') {
        if(empty($var)){
