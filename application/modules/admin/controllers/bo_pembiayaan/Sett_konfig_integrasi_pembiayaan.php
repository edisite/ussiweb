...
/**
 * Description of Sett_konfig_integrasi_pembiayaan
 *
 * @author edisite
 */
class Sett_konfig_integrasi_pembiayaan extends Admin_Controller{
    //put your code here
    public function __construct() {
        parent::__construct();
    }
    public function index() {
        $crud = $this->generate_crud('kre_integrasi');
...
*/
	...
	$this->mTitle.= '[4005]KONFIGURASI INTEGRASI KREDIT / PEMBIAYAAN';
        $this->render_crud();
    }
}
