...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="box box-primary">
            ...
            <div class="box-body">
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="report/trans_simpanan/mutasi_simpanan_per_rekening" method="post">
               <div class="form-group">
                   ...
                   <label class="control-label col-md-2 col-sm-3 col-xs-12">Sampai Tanggal</label>
                    ...
                    <div class="col-md-5 col-sm-3 col-xs-12">
                        <select class="form-control" name="kdtransaksi">
