      ...
      <div class="box box-primary">
            ...
            <div class="box-body">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <select class="form-control" name="usrid">
                            ...
                            <?php foreach ($datauser as $useradm) {
                              echo "<option value=".$useradm->id.">".$useradm->first_name." ".$useradm->last_name."</option>";
                          }?>
                      </select>
                    </div>
               </div>
               <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <select class="form-control" name="kode_perk">
                            <option value="">Choose options</option>
                            <?php foreach ($datakas as $kas) {
                              echo "<option value=".$kas->kode_perk.">".$kas->kode_perk." - ".$kas->nama_perk."</option>";
                            }?>
                      </select>
                    </div>                            
                </div>        
