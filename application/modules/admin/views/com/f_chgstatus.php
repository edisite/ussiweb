            ...
            <div class="box-body">
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">   
                    ...
                    <input type="hidden" name="useridtrx" class="form-control" value="<?php echo $userid_com; ?>">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Harga Provider  </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <label>Cth: 4950 <i>(Tanpa koma) Ket: Harga diambil dari pihak provider</i></label>
                          <input type="text" class="form-control" name="sn_harga" value="" placeholder="Rupiah">
                        </div>
                      </div>
                      <div class="form-group">
