              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <form name="simpanan" action="<?php echo base_url();?>admin/tpembelian/com/pln_pra_purchase" method="post" accept-charset="utf-8">
                  <div class="modal-body">
                      ...
                      <input  type="hidden" id="produk" name="produk" class="form-control input-sm" value="<?php echo $produk; ?>">
                            <input  type="hidden" id="meterid" name="meterid" class="form-control input-sm" value="<?php echo $plnid; ?>">
                  ...
                  <div class="modal-footer">
                    <button onclick="location.href='<?php echo base_url();?>admin/tpembelian/com/pln'" type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancel</button>
