<?php
class Tabung_nasabah_join_model extends Grocery_crud_model
{
    ...
    function get_list()
    {
        ...
        $this->db->from('tabung,nasabah');
        //$this->db->where('tabung.no_rekening='.$this->table_name.'.no_rekening');
        $this->db->where('tabung.NASABAH_ID='.$this->table_name.'.NASABAH_ID');            
